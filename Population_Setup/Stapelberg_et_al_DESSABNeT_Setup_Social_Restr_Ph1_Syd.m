...
%% DESSABNeT Population Setup. Copyright (C) Nicolas J. C. Stapelberg 2020, 2021, All Rights Reserved 
    ...
    % Method and Validation Using SARS-CoV-2 Data in Three Large Australian Cities. PlosOne  
     ...
     %% Social Restriction Parameters Module:
        ...
        % Discretionary Time:
        Perc_Leisure_Activity = 11.4; % Large Group Exposure
        Perc_Social_Activity = 40.4; % Medium Group Exposure
        Perc_Home_Activity = 48.2; % Solitary Home Activity
        
        % Essential Activities:
        Essential_Visits_per_Week = 3; % Number of visits for essential activities (medical, pharmacy, food shopping)
        
        % Social Activities:
        Friend_Contacts_per_Week = 5; % Number of friend and kin visits per week (these occur in the evenings and are separate from Discretionary Time activites above)
        
        % Work:
        Work_From_Home = 30.2; %Percentage of agents working from home, for those agents who are employed
        
        % Public Transport:
        Public_Transport = 32.9; % Percentage of the population that use public transport

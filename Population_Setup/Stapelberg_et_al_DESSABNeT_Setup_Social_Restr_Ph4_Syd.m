...
%% DESSABNeT Population Setup. Copyright (C) Nicolas J. C. Stapelberg 2020, 2021, All Rights Reserved 
    ...
    % Method and Validation Using SARS-CoV-2 Data in Three Large Australian Cities. PlosOne  
     ...
     %% Social Restriction Parameters Module:
        ...
        Perc_Social_Activity = 0; % Medium Group Exposure
        Perc_Home_Activity = 100; % Solitary Home Activity
        
        % Essential Activities:
        Essential_Visits_per_Week = 3; % Number of visits for essential activities (medical, pharmacy, food shopping)
        
        % Social Activities:
        Friend_Contacts_per_Week = 2; % Number of friend and kin visits per week (these occur in the evenings and are separate from Discretionary Time activites above)
        
        % Work:
        Work_From_Home = 64; %Percentage of agents working from home, for those agents who are employed
        
        % Public Transport:
        Public_Transport = 8; % Percentage of the population that use public transport
